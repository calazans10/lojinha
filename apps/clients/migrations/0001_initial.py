...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field addresses on 'Client'
        m2m_table_name = db.shorten_name('client_addresses')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('client', models.ForeignKey(orm['clients.client'], null=False)),
            ('address', models.ForeignKey(orm['clients.address'], null=False))
        ))
        db.create_unique(m2m_table_name, ['client_id', 'address_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field addresses on 'Client'
        db.delete_table(db.shorten_name('client_addresses'))
    ...
    models = {
        ...
        'clients.address': {
            'Meta': {'db_table': "'address'", 'object_name': 'Address'},
        ...
        'clients.client': {
            ...
            'addresses': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['clients.Address']", 'symmetrical': 'False'}),

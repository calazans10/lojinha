...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('category', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', to=orm['products.Category'], null=True)),
    ...
    models = {
        'products.category': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'to': "orm['products.Category']", 'null': 'True'}),
